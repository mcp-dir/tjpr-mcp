...
### Jurisprudência do TJPR para Claude, Cursor e agentes de IA
...
- ⚖️ **TJPR** e mais 16 tribunais na mesma conexão, incluindo STF, STJ e TST
- 📚 **Cível, consumidor, família e imobiliário**
...
**Manual** (se o deeplink não abrir): [claude.ai/customize/connectors](https://claude.ai/customize/connectors?surface=cowork) → **+** → **Adicionar conector personalizado** → cole **Nome** `Jurisprudência TJPR` e **URL** `https://api.mcp.ai/p_tjpr`.

### Cursor

[➕ Instalar Jurisprudência TJPR no Cursor](cursor://anysphere.cursor-deeplink/mcp/install?name=tjpr&config=eyJ1cmwiOiJodHRwczovL2FwaS5tY3AuYWkvcF90anByIn0=)

### VS Code (Copilot Chat)

[➕ Instalar Jurisprudência TJPR no VS Code](vscode:mcp/install?name=tjpr&config=%7B%22type%22%3A%22http%22%2C%22url%22%3A%22https%3A%2F%2Fapi.mcp.ai%2Fp_tjpr%22%7D)
...
MIT — veja [LICENSE](LICENSE). O servidor MCP em `api.mcp.ai/p_tjpr` é proprietário (hosted); este repositório (manifestos, docs, skills) é MIT.
